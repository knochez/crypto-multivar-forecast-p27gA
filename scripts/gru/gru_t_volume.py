"""
gru_volume.py — BTC Trading Volume forecasting using GRU
=========================================================
...
GRU settings for volume:
  - Same aggressive settings as price (128 hidden, OneCycleLR)
  - Slightly lower max_lr=0.005 to reduce risk of divergence at long lookbacks
  - GRU fewer parameters than LSTM may help prevent the collapse seen at lb=8
"""
...
RESULTS_DIR  = "results_gru_volume"
...
def plot_predictions(dates, yt, yp, lb, m):
    ...
    ax.plot(dates, yp, color="#D85A30", linewidth=1.1,
            ...
            label="Predicted btc trading volume — GRU model one-day-ahead forecast")
...
def main():
    ...
    for i, lb in enumerate(LOOKBACKS, 1):
        ...
        torch.save(model.state_dict(), os.path.join(
            DIRS["model_weights"],
            f"Model_Weights_GRU_Volume_lookback_{lb}d.pt"))
    ...
    csv = os.path.join(DIRS["summary"], "Results_GRU_Volume.csv")
