...
# ============================================================
# FINAL BASELINE LINEAR REGRESSION CODE FOR TRADING VOLUME PREDICTION
...
output_dir = Path("lr_volume_outputs")
...
for coin in coins:
    ...
    for lookback in lookbacks:
        ...
        pred_file = preds_dir / f"{coin.lower()}_lr_volume_lb{lookback}_predictions.csv"
    ...
    for ax, item in zip(axes, subplot_data):
        ...
        ax.set_ylabel("Trading Volume", fontsize=10)
    ...
    fig.suptitle(f"Linear Regression Forecast — {coin} Trading Volume", fontsize=14, y=0.98)
    fig.tight_layout(rect=[0, 0, 0.88, 0.96])

    combined_file = graphs_dir / f"{coin.lower()}_lr_volume_all_lookbacks.png"
...
summary_file = output_dir / "lr_volume_summary.csv"
