...
# ============================================================
# FINAL BASELINE LINEAR REGRESSION CODE FOR LOG RETURN PREDICTION
...
# Output folders
output_dir = Path("lr_logreturn_outputs")
...
for coin in coins:
    ...
    for lookback in lookbacks:
        ...
        pred_file = preds_dir / f"{coin.lower()}_lr_logreturn_lb{lookback}_predictions.csv"
    ...
    fig.suptitle(f"Linear Regression Forecast — {coin} Log Return", fontsize=14, y=0.98)
    fig.tight_layout(rect=[0, 0, 0.88, 0.96])

    combined_file = graphs_dir / f"{coin.lower()}_lr_logreturn_all_lookbacks.png"
...
summary_file = output_dir / "lr_logreturn_summary.csv"
