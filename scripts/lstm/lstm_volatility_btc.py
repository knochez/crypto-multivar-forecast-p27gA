...
Original file is located at
    https://colab.research.google.com/drive/1saZ5IIqlYif6hWPyw2ii0r9BiBgSS1sj
"""

"""
lstm_volatility.py — BTC 30-Day Realised Volatility forecasting using LSTM
=========================================================================
...
# Trains LSTM with fixed LR and ReduceLROnPlateau, returns best model by val loss
...
def plot_predictions(dates, yt, yp, lb, m):
    ...
    ax.plot(dates, yp, color="#D85A30", linewidth=1.1,
            ...
            label="Predicted volatility — LSTM model one-day-ahead forecast")
    ax.set_title(
...
def main():
    ...
    for i, lb in enumerate(LOOKBACKS, 1):
        ...
        torch.save(model.state_dict(), os.path.join(
            DIRS["model_weights"],
            f"Model_Weights_LSTM_Volatility_lookback_{lb}d.pt"))
    ...
    csv = os.path.join(DIRS["summary"], "Results_LSTM_Volatility.csv")
